...
<section class="hero">
  <canvas id="metric-network-canvas" class="hero-canvas" aria-label="A live random geometric graph with filled triangular faces and its running Euler characteristic" aria-hidden="true"></canvas>
