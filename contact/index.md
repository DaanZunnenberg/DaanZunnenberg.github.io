...
<form class="contact-form" data-u="dw.zunnenberg" data-d="gmail.com" method="POST">
  <input type="hidden" name="_subject" value="New professional inquiry from daanzunnenberg.com">
  ...
  <div class="field">
    ...
    <select id="topic" name="topic">
      ...
      <option value="Advisory or panel">Advisory conversation or panel</option>
...
<p class="tagline">Code, publications, and professional history, hosted where they actually live.</p>
...
<div class="dest-grid">
  <button type="button" class="dest-card copy-email" data-u="dw.zunnenberg" data-d="gmail.com">
    ...
    <span class="dest-icon" aria-hidden="true">
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 4h20v16H2V4zm10 7L4 6v2l8 5 8-5V6l-8 5z"/></svg>
    </span>
    <span class="dest-text">
      <span class="dest-title">Email</span>
      <span class="dest-desc">Click to copy my address.<span class="copy-toast">Copied</span></span>
    </span>
  </button>
  <a class="dest-card" href="https://github.com/DaanZunnenberg" target="_blank" rel="noopener noreferrer">
    <span class="dest-card-accent" aria-hidden="true"></span>
    <span class="dest-icon" aria-hidden="true">
    ...
    <span class="dest-text">
      <span class="dest-title">GitHub</span>
      <span class="dest-desc">Source code for research and side projects.</span>
    </span>
  </a>
  <a class="dest-card" href="https://www.linkedin.com/in/daanzunnenberg/" target="_blank" rel="noopener noreferrer">
    <span class="dest-card-accent" aria-hidden="true"></span>
    <span class="dest-icon" aria-hidden="true">
    ...
    <span class="dest-text">
      <span class="dest-title">LinkedIn</span>
      <span class="dest-desc">Professional network and career history.</span>
    </span>
  </a>
  <a class="dest-card" href="https://scholar.google.com/citations?user=JLg2KjEAAAAJ" target="_blank" rel="noopener noreferrer">
    <span class="dest-card-accent" aria-hidden="true"></span>
    <span class="dest-icon" aria-hidden="true">
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 3 1 8l11 5 9-4.09V17h2V8L12 3zm-7 9.18V16c0 2.21 3.13 4 7 4s7-1.79 7-4v-3.82l-7 3.18-7-3.18z"/></svg>
    </span>
    <span class="dest-text">
      <span class="dest-title">Google Scholar</span>
      <span class="dest-desc">Publications and citations.</span>
    </span>
  </a>
</div>
