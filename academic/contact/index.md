...
<section class="hero">
  <canvas id="convergence-widget-canvas" class="hero-canvas" aria-label="Animated pulses converging from several points toward a central hub" aria-hidden="true"></canvas>
