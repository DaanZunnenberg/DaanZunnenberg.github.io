...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-links">
      <button type="button" class="copy-email" data-copy="dw.zunnenberg@gmail.com"><svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M2 4h20v16H2V4zm10 7L4 6v2l8 5 8-5V6l-8 5z"/></svg>Email<span class="copy-toast">Copied</span></button>
