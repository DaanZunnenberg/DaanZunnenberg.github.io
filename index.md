...
<div class="profile-header">
  ...
  <div class="profile-intro">
    <h1>Daan Zunnenberg</h1>
    <div class="tagline">PhD Researcher in Mathematics, Leiden University &middot; Quantitative Researcher</div>
...
<p class="lede">
I work at the intersection of probability theory and quantitative finance &mdash; proving convergence results
for stochastic processes, then building the estimation and execution systems that put those ideas into production.
</p>
...
<p>
Outside of proofs and production systems, I'm usually on a padel court, working through a reading list that
swings between fiction and non-fiction, or planning the next trip &mdash; travel is one of the few things
that gets me to properly close the laptop. I try to stay active more broadly too; padel just happens to be
the one that stuck.
</p>
