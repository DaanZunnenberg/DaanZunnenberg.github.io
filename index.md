...
<section class="hero">
  <canvas id="market-depth-canvas" class="hero-canvas" aria-label="Abstract institutional market-depth profile, showing cumulative liquidity either side of a mid price" aria-hidden="true"></canvas>
  ...
  <div class="hero-content">
    ...
    <p class="hero-lede">PhD researcher in probability theory, working at the intersection of <em>generic chaining</em> and quantitative finance.</p>
