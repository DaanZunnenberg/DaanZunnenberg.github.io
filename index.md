...
<div class="tagline">PhD Researcher, Mathematics — Leiden University &middot; Quantitative Researcher</div>
...
<p class="lede">
I work at the intersection of probability theory and quantitative finance: proving convergence results for
stochastic processes, and building estimation and execution systems that put related ideas into production.
</p>
...
<div class="entry">
  ...
  <ul>
    ...
    <li>Developed a novel functional stationarity test for multidimensional diffusion processes as a thesis project, packaged as an open-source <a href="https://github.com/DaanZunnenberg/MultivariateHamrickTaqqu">repository</a>.</li>
...
<div class="entry">
  ...
  <ul>
    <li>Minor in Big Data Analytics, focused on model training, evaluation, and deployment.</li>
  </ul>
</div>
