...
<div class="article-figure">
  <img src="{{ '/images/volatility/quant_finance.jpg' | relative_url }}?v={{ site.time | date: '%s' }}" alt="Empirical-theoretic quantile-quantile plots of S&P 500 returns against the student-t distribution at nu equals infinity (Gaussian) and nu equals 5 degrees of freedom">
